...
public class Mage extends Character{
	...
	public Mage(DoodleTactics dt, GameScreen container, String profile, String left, String right, String up, String down, String name,double x, double y, int level){
		super(dt,container, profile, left, right, up, down, name,x,y);
